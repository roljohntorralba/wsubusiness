...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'wsubusiness' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'wsubusiness' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'wsubusiness' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'wsubusiness' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'wsubusiness' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'wsubusiness' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'wsubusiness' ); ?>',
} );
#>
