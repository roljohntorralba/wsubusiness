...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'wsubusiness' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'wsubusiness' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'wsubusiness' ),
			'200'       => esc_html__( 'Light 200', 'wsubusiness' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'wsubusiness' ),
			'300'       => esc_html__( 'Book 300', 'wsubusiness' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'wsubusiness' ),
			'400'       => esc_html__( 'Normal 400', 'wsubusiness' ),
			'regular'   => esc_html__( 'Normal 400', 'wsubusiness' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'wsubusiness' ),
			'500'       => esc_html__( 'Medium 500', 'wsubusiness' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'wsubusiness' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'wsubusiness' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'wsubusiness' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'wsubusiness' ),
			'700'       => esc_html__( 'Bold 700', 'wsubusiness' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'wsubusiness' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'wsubusiness' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'wsubusiness' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'wsubusiness' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'wsubusiness' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'wsubusiness' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'wsubusiness' ),
		);
	}
